## ScaleMamba: Dynamic Multi-Scale Graph State Space Learning for Traffic Forecasting in Urban IoT Sensing NetworksScaleMamba: A Multi-scale Selective State Space Model for Traffic Flow Predicti
